 ...
 <hr style="clear:both;">
              ...
              <c:forEach items="${page.list}" var="admin" varStatus="status">
                <tr>
                  ...
                  <td>
					  ...
					  <button type="button" adminId="${admin.id}" class="deleteBtnClass btn btn-danger btn-xs"><i class=" glyphicon glyphicon-pencil"></i></button>
				  </td>
                </tr>
                </c:forEach>
        ...
        <script type="text/javascript">
            ...
            $("#deleteBatchBtn").click(function(){
            	...
            	layer.confirm('您是否确定删除这些数据？',{btn:['确定','取消']},function(index){
